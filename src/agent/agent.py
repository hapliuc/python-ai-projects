...
def main() -> None:
    ...
    system_prompt: dict = {'role': 'system', 'content': 'You are a helpful AI chatbot with agentic capabilities. Use the tools you have acces to, to fulfill user requests'}
